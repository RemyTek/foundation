...
G_CVAR( instagib, "instagib", "0", CVAR_SYSTEMINFO | CVAR_LATCH, 0, qtrue )
G_CVAR( g_railjump, "g_railjump", "0", CVAR_ARCHIVE, 0, qtrue )
G_CVAR( g_noSelfDamage, "g_noSelfDamage", "0", CVAR_ARCHIVE, 0, qtrue )
G_CVAR( g_startArmor, "g_startArmor", "0", 0, 0, qfalse )
G_CVAR( g_startHealth, "g_startHealth", "0", 0, 0, qfalse )
