...
G_CVAR( g_mercylimit, "mercylimit", "8", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue, qfalse )
...
// Per-movement-type physics overrides.
// Any cvar with value -1 keeps the current movetype default.
G_CVAR( pmove_AirAccel,                         "pmove_AirAccel",                         "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_AirControl,                       "pmove_AirControl",                       "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_AirStepFriction,                  "pmove_AirStepFriction",                  "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_AirSteps,                         "pmove_AirSteps",                         "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_AirStopAccel,                     "pmove_AirStopAccel",                     "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_AutoHop,                          "pmove_AutoHop",                          "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_BunnyHop,                         "pmove_BunnyHop",                         "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_ChainJump,                        "pmove_ChainJump",                        "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_ChainJumpVelocity,                "pmove_ChainJumpVelocity",                "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_CircleStrafeFriction,             "pmove_CircleStrafeFriction",             "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlide,                      "pmove_CrouchSlide",                      "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlideFriction,              "pmove_CrouchSlideFriction",              "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlideTime,                  "pmove_CrouchSlideTime",                  "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchStepJump,                   "pmove_CrouchStepJump",                   "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_DoubleJump,                       "pmove_DoubleJump",                       "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_JumpTimeDeltaMin,                 "pmove_JumpTimeDeltaMin",                 "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocity,                     "pmove_JumpVelocity",                     "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityMax,                  "pmove_JumpVelocityMax",                  "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityScaleAdd,             "pmove_JumpVelocityScaleAdd",             "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityTimeThreshold,        "pmove_JumpVelocityTimeThreshold",        "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityTimeThresholdOffset,  "pmove_JumpVelocityTimeThresholdOffset",  "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_RampJump,                         "pmove_RampJump",                         "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_RampJumpScale,                    "pmove_RampJumpScale",                    "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_StepHeight,                       "pmove_StepHeight",                       "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_StepJump,                         "pmove_StepJump",                         "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_StepJumpVelocity,                 "pmove_StepJumpVelocity",                 "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_StrafeAccel,                      "pmove_StrafeAccel",                      "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_Velocity_gh,                      "pmove_Velocity_gh",                      "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_WalkAccel,                        "pmove_WalkAccel",                        "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_WalkFriction,                     "pmove_WalkFriction",                     "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_WaterSwimScale,                   "pmove_WaterSwimScale",                   "-1", 0, 0, qfalse, qfalse )
G_CVAR( pmove_WaterWadeScale,                   "pmove_WaterWadeScale",                   "-1", 0, 0, qfalse, qfalse )
