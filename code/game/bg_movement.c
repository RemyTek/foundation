...
// Legacy OSP mode globals required by shared OSP code paths in this codebase.
int   modePromodePhysKoeff = 0;
float modePromode_pm_airaccelerate_1 = 1.0f;
int   modePredictionKoeff2 = 0;
float modePromode_pm_airaccelerate_2 = 1.0f;
float modeWishspeedLimit = 400.0f;
int   modePredictionKoeff1 = 0;
float modeSwimScale1 = 0.50f;
float modeSwimScale2 = 0.70f;
float modeShotgunKoeff = 700.0f;
int   modeShotgunNumberOfPellets = 11;
float modeUnused8 = 0.0f;
int   modeMaxAmmoShotgun = 200;
int   modeGrenadeTime = 800;
int   modeMaxAmmoGrenade = 200;
int   modeMaxAmmoRocket = 200;
int   modeMaxAmmoRail = 200;
int   modeBeginWeaponChangeTime = 200;
int   modeFinishWeaponChangeTime = 250;
int   modePMNoAmmoTime = 500;
int   pm_armorPromode = 0;
int   modeHitLevelSounds = qfalse;
int   modePickupDistance = 36;
int   modeUnknown2 = 0;
int   modeUnknown3 = 0;
int   modeUnknown4 = 0;
int   modeShotgunPromode = 0;
